...
class SummarizationGUI:
    ...
    def setup_gui(self):
        ...
        # Tab 1: Summarization
        self.summarization_tab = tk.Frame(self.notebook, bg=bg_color)
        self.notebook.add(self.summarization_tab, text="Summarization")

        # Tab 2: Training Metrics
        self.metrics_tab = tk.Frame(self.notebook, bg=bg_color)
        self.notebook.add(self.metrics_tab, text="Training Metrics")

        # Setup tabs
        self.setup_summarization_tab(self.summarization_tab, bg_color, header_color)
        self.setup_metrics_tab(self.metrics_tab, bg_color)

    def setup_summarization_tab(self, parent, bg_color, header_color):
        """Setup the summarization tab"""
